...
WebServer server(80);
WiFiServer nmeaServer(8880);  // TCP Server pour recevoir NMEA depuis XCSoar
WiFiClient nmeaClient;        // Client TCP connecté
...
bool SourceIsWifi = false;    // true quand une source TCP WiFi est connectée
