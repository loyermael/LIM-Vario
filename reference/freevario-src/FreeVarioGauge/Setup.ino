void setup() {
  ...
  // Démarrage WiFi AP + serveur TCP NMEA (toujours actif)
  ...
  Serial.println("WiFi AP starté : " + String(ssid));
  Serial.println("IP : " + displayIP);
  Serial.println("TCP NMEA Server sur port 8880");
  SPIFFSstart();
